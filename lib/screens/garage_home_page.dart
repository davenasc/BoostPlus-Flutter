  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('45,000 km', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
                  const Text('Honda Civic · ABC-1234', style: TextStyle(color: Colors.white70)),
                ],
              ),
            ),
          ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          UpdateKmDialog.show(context, 45000, (newKm) {
            // TODO: implementar a lógica real para salvar a kilometragem
            print('Nova Km salva: $newKm');
          });
        },
